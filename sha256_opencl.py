    ...
    def process_dual_camera_guess(self):
        ...
        try:
            ...
            if cam0_below and cam1_below:
                ...
                if calculate_sha256_with_opencl("GeorgeW", prefix="00000000", work_items=1000000, nonce_offset=self.init_count): # measure comparisons
                    # Win scenario
                    game_state["credits"] += COST_PER_GUESS
            ...
            self.init_count = (self.init_count + 1000000) % 1000000000000000
