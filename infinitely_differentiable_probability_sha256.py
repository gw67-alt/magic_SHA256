...
def number_guessing_game():
    ...
    def check_guess():
        ...
        try:
            ...
            target_hash_prefix = "0" * 5
            # --- Check the guess ---
            if calculate_sha256_with_library("GeorgeW"+ str(guess)).startswith(target_hash_prefix) == calculate_sha256_with_library("GeorgeW"+ str(target_number)).startswith(target_hash_prefix):
            ...
            elif calculate_sha256_with_library("GeorgeW"+ str(guess)).startswith(target_hash_prefix) < calculate_sha256_with_library("GeorgeW"+ str(target_number)).startswith(target_hash_prefix):
